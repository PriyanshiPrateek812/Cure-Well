...
import com.thepriyanshiprateek.cure_well.payload.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(CureWellException.class)
    public ResponseEntity<ErrorDetail> handleCureWellException(CureWellException ex, WebRequest request){
